...
export default function AyudaPage() {
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      <div className="flex items-center justify-between border-b border-[#c6a96b]/20 pb-6">
        <div>
          <h1 className="text-3xl font-bold text-[#f5efe6] font-serif flex items-center gap-3">
            <BookOpen className="w-8 h-8 text-[#c6a96b]" />
      ...
      <div className="space-y-12">
        {/* Sección 1 */}
        <section>
          <h2 className="text-2xl font-semibold text-[#f5efe6] mb-4 flex items-center gap-2">
            <ShieldAlert className="w-6 h-6 text-orange-400" />
            1. Inicio de Sesión y Acceso
          </h2>
          <div className="bg-[#2a1a18] rounded-xl shadow-sm border border-[#c6a96b]/20 p-6 space-y-4 text-[#f5efe6]/70">
            <p>
              Para acceder a las funciones administrativas y poder gestionar los puntos, presupuestos y clientes, 
              debes iniciar sesión con una cuenta autorizada a través de <strong className="text-[#f5efe6] font-serif">/admin/login</strong>.
            </p>
            <div className="bg-orange-900/30 border-l-4 border-orange-400 p-4 rounded-r-lg text-sm text-orange-800">
        ...
        {/* Sección 2 */}
        <section>
          <h2 className="text-2xl font-semibold text-[#f5efe6] mb-4">
            2. Navegación por el Panel de Control
          </h2>
          
          <div className="grid gap-6">
            <div className="bg-[#2a1a18] rounded-xl shadow-sm border border-[#c6a96b]/20 p-6">
              <h3 className="text-lg font-bold text-[#f5efe6] font-serif mb-2 flex items-center gap-2">
                <BarChart3 className="w-5 h-5 text-[#c6a96b]" />
                Métricas (Resumen General)
              </h3>
              <p className="text-[#f5efe6]/70 text-sm mb-3">
            ...
            <div className="bg-[#2a1a18] rounded-xl shadow-sm border border-[#c6a96b]/20 p-6">
              ...
              <ul className="list-disc list-inside text-sm text-[#f5efe6]/70 space-y-2 ml-4">
        ...
        <section>
          ...
          <div className="bg-green-900/30 rounded-xl shadow-sm border border-green-100 p-6">
            <ol className="list-decimal list-inside text-[#f5efe6]/80 space-y-4">
